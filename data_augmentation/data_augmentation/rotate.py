...
np.random.seed(24)
data = ImageDataBunch.from_folder('../data/MURA-v1.1/data2/', ds_tfms=get_transforms(do_flip=False, max_rotate=30,max_warp=0.0, p_lighting=0), size=size, bs=bs).normalize(imagenet_stats)
