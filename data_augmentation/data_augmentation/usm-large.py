...
np.random.seed(24)
data = ImageDataBunch.from_folder('../data/MURA-v1.1/data2/', ds_tfms=get_transforms(do_flip=False, max_warp=0., xtra_tfms=[usm(size=(5,5), strength=7.5, p=0.9)]), size=size, bs=bs).normalize(imagenet_stats)
