...
# vae.save_weights('vae_mlp25_semi.h5')

vae.load_weights('/pool001/bibek/hst/semisupervised/vae100/vae.050.h5')
...
#                         steps_per_epoch = train_batches.samples * 0.25 // batch_size,
...
# full_model.save('vae_classification25_semi.h5')
...
# full_model.save('vae_classification_complete25_semi.h5')
...
full_model.load_weights('/pool001/bibek/hst/semisupervised/trainvaeclf25_semi/clf_128.002.h5')
