...
# vae.save_weights('vae_mlp50_semi.h5')
...
#                         steps_per_epoch = train_batches.samples * 0.50 // batch_size,
...
# full_model.save('vae_classification50_semi.h5')
...
# full_model.save('vae_classification_complete50_semi.h5')
...
full_model.load_weights('/pool001/bibek/hst/semisupervised/trainvaeclf50_semi/clf_128.048.h5')
