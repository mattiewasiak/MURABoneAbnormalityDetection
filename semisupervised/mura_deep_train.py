...
full_model.load_weights('/pool001/bibek/hst/semisupervised/deep_trainclf1/clf_128.021.h5')
...
# full_model.save('deep_autoencoder_classification_3.h5')
...
# full_model.save('deep_classification_complete_3.h5')
