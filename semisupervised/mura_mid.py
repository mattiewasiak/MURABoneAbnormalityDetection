...
# autoencoder.save('mid_autoencoder.h5')

autoencoder.load_weights('/pool001/bibek/hst/semisupervised/mid_autoencoder1/ae_c5_d10.005.h5')
...
# full_model.save('mid_autoencoder_classification.h5')
...
full_model.save('mid_classification_complete.h5')
