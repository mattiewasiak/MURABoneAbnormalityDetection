...
# full_model.save('deep_autoencoder_classification_25.h5')
...
# full_model.save('deep_classification_complete_25_1.h5')
...
full_model.load_weights('/pool001/bibek/hst/semisupervised/deep_trainclf25_1/clf_128.004.h5')
