...
# vae.save_weights('vae_mlp75_semi.h5')
...
# full_model.save('vae_classification75_semi.h5')
...
# full_model.save('vae_classification_complete75_semi.h5')
...
full_model.load_weights('/pool001/bibek/hst/semisupervised/trainvaeclf75_semi/clf_128.041.h5')
