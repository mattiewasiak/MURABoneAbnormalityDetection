...
learner = cnn_learner(data, models.vgg19_bn, pretrained=False, metrics=[error_rate, accuracy, kappa], wd=0.1, model_dir="./models/").to_fp32()
learner.unfreeze()
learner.fit_one_cycle(5, callbacks=[ShowGraph(learner) ,SaveModelCallback(learner)])

learner.save('vgg19bn-random')