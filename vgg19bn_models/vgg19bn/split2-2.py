...
learner.unfreeze()
learner.fit_one_cycle(5,max_lr=slice(1e-4/100, 1e-4), callbacks=[ShowGraph(learner) ,SaveModelCallback(learner)])

learner.save('vgg19bn-1-2-2')
